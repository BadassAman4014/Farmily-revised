...
class _SeedsScreenState extends State<SeedsScreen> {
  ...
  FirebaseDatabase.instance.reference().child('seeds');
  ...
  Future<void> _loadSeeds() async {
    _databaseReference.onValue.listen((event) {
      ...
      if (snapshot.value is Map<dynamic, dynamic>) {
        ...
        seeds.clear(); // Clear the old data
        values.forEach((key, value) {
          if (value is Map<dynamic, dynamic>) {
            seeds.add(Map<String, dynamic>.from(value));
          }
        });
      ...
      home: Scaffold(
        ...
        body: GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return InkWell(
              onTap: () {
                _showDetailsDialog(seeds[index]);
              },
              child: Card(
